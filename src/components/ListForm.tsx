  ...
  return (
    <div className="flex flex-col h-screen bg-neutral-900">
      ...
      <div className="flex-grow flex my-10">
        <div
          className="w-1/6 h-[120px] mx-5 shadow-inner rounded-md shadow-[rgba(255,255,255,0.2)] flex justify-center items-center cursor-pointer hover:bg-gray-700 transition-colors duration-300 ease-in-out"
        ...
        {previousForms.map((formName, index) => (
          <div
            key={index}
            className="w-1/6 h-[120px] mx-5 flex justify-center items-center shadow-inner rounded-md shadow-[rgba(255,255,255,0.2)] cursor-pointer hover:bg-gray-700 transition-colors duration-300 ease-in-out"
            onClick={() => preview(formName)}
          >
